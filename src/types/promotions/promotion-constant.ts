...
export type PromotionTypes = (typeof PROMOTION_TYPES)[keyof typeof PROMOTION_TYPES];

export const PROMOTION_DISCOUNT_TYPE = ['percentage', 'fixed'] as const;

export const PROMOTION_DISCOUNT_DAYS = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] as const;
...
export type PromotionStatus = 'active' | 'disabled' | 'ended' | 'redeemed_out' | 'scheduled';
