    ...
    setDraft((prev) => ({
      ...
      shippingAddress: myAddress
        ? {
            ...
            city: myAddress.city || '',
            cityCode: myAddress.cityCode || prev.shippingAddress.cityCode,
            province: myAddress.province || '',
            zipCode: myAddress.zipCode || '',
            landmark: myAddress.landmark || '',
            barangayCode: myAddress.barangayCode || prev.shippingAddress.barangayCode,
            subMunicipality: myAddress.subMunicipality || prev.shippingAddress.subMunicipality,
            subMunicipalityCode: myAddress.subMunicipalityCode || prev.shippingAddress.subMunicipalityCode,
            region: myAddress.region || prev.shippingAddress.region,
            regionCode: myAddress.regionCode || prev.shippingAddress.regionCode,
            placeName: myAddress.placeName || prev.shippingAddress.placeName,
            coordinates: myAddress.coordinates || prev.shippingAddress.coordinates,
          }
        : prev.shippingAddress,
    }));
